...
At the start of every session: read `mementum/state.md`. Follow any related links. Search
for memories relevant to the current task. This takes ~30 seconds and is always the first
action.

## Approval Gate

Always propose memories to the human before committing. Never commit to `mementum/`
