...
λ gybis-spec-distill().
  ...
  INV≡noDBTypes∥noORM∥noHTTP∥noFramework∥noLangTypes∥noVarNames∥noInfra∥noTokens∥oneNamePerConcept∥¬includeDeadCode∥spec=Intent≠Bug∥concreteDetail:couldBeD  ifferent?∥multipleImpls?→domainConcern∥output=Σspecs/{specs/<domain>/<name>.allium}∥alliumMarker(3,firstLine)∥scopeDecisions(included∥excluded)
