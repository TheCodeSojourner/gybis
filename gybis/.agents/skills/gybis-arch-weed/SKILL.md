...
λ gybis-arch-weed_identify_divergences(vsm_layers, spec_directives).
  ∀ layer ∈ vsm_layers:
...
λ gybis-arch-weed_verify_consistency(x).
  ...
  | invoke(gybis-arch-weed_identify_divergences(vsm_layers, spec_directives)) → remaining_divergences
