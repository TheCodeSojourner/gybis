...
- **Tool-agnostic positioning established**: gybis skills work with any AI tool supporting `skills/` directory; `.cline/` is this repo's local workspace convention
- Monitor for: New skills added to gybis/.cline/skills/ directory
