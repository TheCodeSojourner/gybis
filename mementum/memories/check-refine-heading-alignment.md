...
Practical rule:
- Update command tables and aliases.
- Update philosophy header/summary sentence.
- Update default sequence text (`check -> refine -> tend -> weed`).

This prevents semantic drift between narrative guidance and command availability.