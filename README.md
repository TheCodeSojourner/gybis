...
- **Architecture model**: an AI generated and maintained 5-layer architectural specification that an AI automatically receives in every interaction and keeps up to date as projects evolve.
